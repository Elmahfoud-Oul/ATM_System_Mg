...
int withdraw()
{
    ...
    else
    {
        ...
        amo[lp] = amt;
        lp++;
        printf("Amount withdrawal: %2.2f DH\n", amt);
        balance = balance - amt;
        printf("Current Balance:   %2.2f DH\n", balance);
...
int transfer()
{
    ...
    else
    {
        ...
        amo[lp] = amt;
        lp++;
        printf("Amount transfered: %2.2f DH\n", amt);
        balance = balance - amt;
        printf("Current Balance:   %2.2f DH\n", balance);
